      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ">
          ...
          <li v-if="!isAdmin" class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="preguntasDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
...
<style scoped>
  ...
  .nav-link:hover {
    color: darken(var(--color-secundario), 10%);
  }
